 ...
 */
final class Version20201212084305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaires CHANGE articles_id article_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaires CHANGE article_id articles_id INT NOT NULL');
